...
import com.sptracer.util.ByteUtils;
...
public class TraceContext implements Recyclable {
    ...
    private TraceContext(SpTracerImpl tracer, Id id) {
     ...
     */
    public static TraceContext with64BitId(SpTracerImpl tracer) {
     ...
     * @param tracer a valid tracer
     */
    public static TraceContext with128BitId(SpTracerImpl tracer) {
    ...
    public com.sptracer.impl.Span createSpan() {
