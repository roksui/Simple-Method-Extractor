...
import static com.sptracer.matcher.CustomElementMatchers.isProxy;
import static com.sptracer.matcher.CustomElementMatchers.matches;
...
public class TraceMethodInstrumentation extends TracerAwareInstrumentation {
    ...
    public TraceMethodInstrumentation(SpTracerImpl tracer, MethodMatcher methodMatcher) {
    ...
    public static class TraceMethodAdvice {
        ...
        private static final SpTracerImpl tracer = GlobalTracer.requireTracerImpl();
