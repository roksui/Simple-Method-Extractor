...
public class AbstractIntakeApiHandler {
    ...
    protected final TracerServerClient tracerServerClient;
    ...
    public AbstractIntakeApiHandler(ReporterConfiguration reporterConfiguration, PayloadSerializer payloadSerializer, TracerServerClient tracerServerClient) {
    ...
    protected HttpURLConnection startRequest(String endpoint) throws Exception {
        ...
        final HttpURLConnection connection = tracerServerClient.startRequest(endpoint);
        if (connection != null) {
    ...
    protected void onConnectionError(@Nullable Integer responseCode, long droppedEvents, long reportedEvents) {
        ...
        if (responseCode == null || responseCode > 429) {
            ...
            tracerServerClient.onConnectionError();
